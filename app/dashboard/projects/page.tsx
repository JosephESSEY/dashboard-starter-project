  ...
  return (
    <div className="px-6 pb-8 space-y-8">
            ...
            <Card className="p-6 bg-card border-border hover:border-primary/50 transition-colors cursor-pointer group">
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between">
                  <div className="w-10 h-10 bg-secondary rounded-lg group-hover:bg-primary/20 transition-colors" />
      ...
      <motion.div variants={itemVariants} initial="hidden" animate="visible">
        <Card className="p-12 bg-secondary border border-border text-center">
